    ...
    public class TaskContent
    {
        ...
        private ObservableCollection<Resource> GetResources()
        {
            if (_resources is null)
            {
                ...
                _resources.Add(new Resource { ID = 1, Name = "R & D" });
                _resources.Add(new Resource { ID = 2, Name = "Analyzers" });
                _resources.Add(new Resource { ID = 3, Name = "Product Definer" });
                _resources.Add(new Resource { ID = 4, Name = "Risk Management" });
                _resources.Add(new Resource { ID = 5, Name = "Budgeting Team" });
                _resources.Add(new Resource { ID = 6, Name = "Developers" });
                _resources.Add(new Resource { ID = 7, Name = "Testers" });
                _resources.Add(new Resource { ID = 8, Name = "Reviewer" });
            }
            return _resources;
        }
